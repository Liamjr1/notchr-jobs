...
export default function EmployerDashboardPage() {
  ...
  const stats = [
    ...
    { label: 'Total Applications', value: jobs.reduce((acc, j) => acc + j.applicationCount, 0), icon: Users, color: 'text-purple-600', bg: 'bg-purple-50' },
                  ...
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3 shrink-0">
                      ...
                      <Link
                        ...
                        className="text-sm text-blue-600 hover:text-blue-700 border border-blue-200 hover:border-blue-300 px-3 py-1.5 rounded-lg transition-colors inline-flex items-center gap-1"
                      >
